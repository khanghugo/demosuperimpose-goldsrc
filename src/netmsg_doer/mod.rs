...
use self::{
    cd_track::CdTrack, center_print::CenterPrint, client_data::ClientData,
    delta_description::DeltaDescription, disconnect::Disconnect, event::Event,
    event_reliable::EventReliable, light_style::LightStyle, new_movevars::NewMovevars,
    new_user_msg::NewUserMsg, particle::Particle, pings::Pings, print::Print,
    ...
    spawn_baseline::SpawnBaseline, spawn_static::SpawnStatic, stop_sound::StopSound,
    stuff_text::StuffText, temp_entity::TempEntity, time::Time, update_user_info::UpdateUserInfo,
    user_message::UserMessage, version::Version,
};
...
impl<'a> NetMsgDoer<'a, Svc<'a>> for What {
    fn parse(i: &'a [u8], _: &mut DeltaDecoderTable) -> IResult<&'a [u8], Svc<'a>> {
        todo!()
    }
